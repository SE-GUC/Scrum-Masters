...
class CompanyUpdate extends Component{
    ...
    getCompany = () => {
    axios.get("http://localhost:3001/api/company/5c94c25663abc339cc17b93b")
    .then(companyy => {
        this.setState({ 
    ...
    handleSubmit = (e , id) => {
        axios.put("http://localhost:3001/api/company/5c94c25663abc339cc17b93b" ,{
          ...
          } ).then(console.log("Succeed")).catch(err => err.state())
    };
    check = () => {
    ...
    render() {
        ...
        </Form.Group><Form.Group controlId = "it">
        ...
        </Form.Group><Form.Group controlId = "if">
        ...
        </Form.Group><Form.Group controlId = "ie">
