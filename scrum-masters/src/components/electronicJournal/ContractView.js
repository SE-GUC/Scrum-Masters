...
class ContractView extends Component {
  ...
  componentDidMount() {
    axios.get("http://localhost:3001/api/company/" + this.props.match.params.company_id)
      .then(company => {
      ...
      <Container style={{ paddingTop: "20px" }}>
        <Card>
          ...
          <div dir="rtl" style={{ textAlign: "right" }}>
            ...
            <Table bordered>
              ...
              <tbody>
                <tr>
                  ...
                  <td>{this.state.investor_id_number}</td>
            ...
            <p>لمؤسس أو مالك الشركة أن يقرر تخفيض رأس مال الشركة لأي سبب ، سواء عن طريق إنقاص عدد الحصص أو تخفيض القيمة الاسمية لكل منها ، وفقاً لأحكام قانون الشركات ولائحته التنفيذية .<br />ولا يجوز تخفيض رأس المال إلى أقل من خمسين ألف جنيه .</p>
            <p>لمؤسس أو مالك الشركة أن يقرر تخفيض رأس مال الشركة لأي سبب ، سواء عن طريق إنقاص عدد الحصص أو تخفيض القيمة الاسمية لكل منها ، وفقاً لأحكام قانون الشركات ولائحته التنفيذية .<br />ولا يجوز تخفيض رأس المال إلى أقل من ما يعادل خمسين ألف جنيه .</p>
