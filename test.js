...
test('update Electronic Journal',async()=>{
  ...
  functions.updateElectronicJournal(EJ.data.data._id,"Egegege",company.data.company_name_english)
  const ej= await functions.getElectronicJournal(EJ.data.data._id)
